...
const LanguageSelector = () => {
  ...
  return (
    <div className="flex items-end text-white">
      <Popover>
        <PopoverTrigger>
          <div className="flex items-center gap-1 fill-black text-white">
            <Languages size={18} />
        ...
        <PopoverContent className="absolute ml-[-50px] mt-1 max-h-60 w-auto overflow-auto rounded-md bg-white p-0 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
